...
// ΓöÇΓöÇΓöÇ Token resolution ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Block Kit builder ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function severityEmoji(event: AlertEvent): string {
    if (event.type === "alert_resolved") return "Γ£à";
    if (event.type === "state_changed") return "≡ƒöä";
    if (event.severity === "critical") return "≡ƒö┤";
    return "ΓÜá∩╕Å";
}
...
function buildBlocks(event: AlertEvent): SlackBlock[] {
    ...
    const header: SlackBlock = {
        ...
        text: {
            type: "plain_text",
            text: `${icon} ${status} ΓÇö ${contractDisplay}`,
            emoji: true,
        },
    };
...
function buildFallbackText(event: AlertEvent): string {
    ...
    if (event.type === "resource_alert") {
        ...
        return (
            `${icon} ${status} ΓÇö ${contractDisplay} (${event.network}) | ` +
        ...
        const diffLabel = event.diff.diffType.charAt(0).toUpperCase() + event.diff.diffType.slice(1);
        return (
            `${icon} State ${diffLabel} ΓÇö ${contractDisplay} (${event.network}) | ` +
            `Entry: ${event.entry.label ?? event.entry.type} | ` +
            `Old: ${event.diff.oldValueXdr ?? "(none)"} ΓåÆ New: ${event.diff.newValueXdr ?? "(none)"}`
        );
    } else if (event.type === "threshold_crossed") {
        ...
        return `${icon} Alert Resolved ΓÇö ${contractDisplay} (${event.network})`;
    }
}
